                    ...
                    <div className='space-y-4'>
                        <div>
                            <input onChange={handleInput}
                                type='text' defaultValue={taskName}
                                name="taskName" placeholder="Add Task Name"
                        ...
                        <div>
                            <input onChange={handleInput}
                                type='text' defaultValue={desc}
                                name="desc" placeholder="Add Task Description"
                                className={`w-full ${theme === 'light' ? '' : 'bg-lightDark text-white border-none'} px-3 py-2 border rounded-md border-gray-300`} required
                            />
                        </div>
                    </div>
                    ...
                    <div className='space-y-2'>
                        <div>
                            <button type='submit' className='bg-violet-500 w-full flex justify-center items-center rounded-md py-2.5 px-3 text-white text-md shadow-md hover:bg-violet-700 hover:shadow-lg focus:bg-violet-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-violet-500 active:shadow-lg transition duration-150 ease-in-out'>
                                ...
                                <span className='px-1'>Update Task</span>
                            </button>
                        </div>
                    </div>
                </form>
